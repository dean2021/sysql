...
func ConnectionsWithPid(kind string, pid int32) ([]Connection, error) {
	var ret []Connection
	...
	r, err := common.CallLsofWithContext(context.Background(), invoke, pid, args...)
	if err != nil {
		return nil, err
	}
	for _, rr := range r {
