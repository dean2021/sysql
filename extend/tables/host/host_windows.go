...
import (
	"context"
	"fmt"
	common2 "github.com/dean2021/sysql/extend/tables/common"
...
func PlatformInformationWithContext(ctx context.Context) (platform string, family string, version string, err error) {
	...
	// Platform
	var h windows.Handle // like HostIDWithContext(), we sysql the registry using the raw windows.RegOpenKeyEx/RegQueryValueEx
...
func UsersWithContext(ctx context.Context) ([]UserStat, error) {
	...
	return ret, common2.ErrNotImplementedError
}
...
func VirtualizationWithContext(ctx context.Context) (string, string, error) {
	return "", "", common2.ErrNotImplementedError
}
